...
public class AdministradorGeneralEntity {
    ...
    public AdministradorGeneralEntity(Long id, String primerNombre, String segundoNombre, String primerApellido, String segundoApellido, String correo, String telefono) {
        this.id = id;
